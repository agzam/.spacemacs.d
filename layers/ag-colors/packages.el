     ...
     (progn
       (let ((base00 "#2b303b")
         ...
         (custom-theme-set-faces
          ...
          `(org-block-begin-line ((t (:underline ,base02 :foreground ,base04 :height 0.9 :weight ultra-light))))
          `(org-block-end-line ((t (:overline ,base02 :foreground ,base04 :height 0.9 :weight ultra-light))))
