  ...
  (pcase spacemacs--cur-theme
    ('spacemacs-light
     (let* ((base00 "#fbf8ef")
            ...
            (base03 "#dedae0")
            (base04 "CadetBlue")
            (faces `((magit-diff-hunk-heading . (:background "#efeae9"))
                     ...
                     (lsp-ui-peek-selection . (:background "#e5e1e0"))

                     (lsp-ui-sideline-current-symbol . (:foreground ,base01))
                     (lsp-ui-sideline-symbol . (:foreground ,base01))
                     (lsp-ui-sideline-code-action . (:foreground "#b7b1ba"))
                     (lsp-ui-doc-background . (:background "#f0ece1"))
                     (markdown-code-face . (:foreground ,base01))
                     (cider-debug-code-overlay-face . (:background "#f0ece1"))
                     ;; (lsp-ui-sideline-global . (:foreground ,base01))

                     ;; org-mode
                     (org-block-begin-line . (:underline ,base03 :background ,base02 :foreground ,base04 :height 0.9 :weight ultra-light))
                     (org-block . (:background ,base02))
                     (org-block-end-line . (:overline ,base03 :background ,base02 :foreground ,base04 :height 0.9 :weight ultra-light))
