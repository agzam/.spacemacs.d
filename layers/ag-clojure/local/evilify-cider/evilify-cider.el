;;; evilify-cider.el --- Evil bindings for Cider -*- lexical-binding: t -*-

;;; Based on emacs-evil/evil-collection
;; https://github.com/emacs-evil/evil-collection/blob/master/modes/cider/evil-collection-cider.el
...
(defun evilify-cider-setup ()
  ...
  (evil-define-key '(normal visual) cider-repl-history-mode-map
...
(provide 'evilify-cider)
;;; evilify-cider.el ends here
